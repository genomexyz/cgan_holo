...
#fixed_z_ = torch.tensor(fixed_z_)
fixed_y_label_ = torch.zeros(100, 10)
fixed_y_label_.scatter_(1, fixed_y_.type(torch.LongTensor), 1)
#fixed_y_label_ = Variable(fixed_y_label_, volatile=True)
#print('cek fixed_z', fixed_z_, fixed_z_.size())
#print('cek fixed_y_label', fixed_y_label_, fixed_y_label_.size())
#exit()
...
for epoch in range(train_epoch):
    ...
    for x_, y_ in train_loader:
        ...
        #print('cek dtrain loss', D_train_loss.item())
